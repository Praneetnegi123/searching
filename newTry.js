let data = [
  ...
  },
  {
    ...
    ScheduleAction:
      "Stand_Stand_Socialize_Sit_Socialize_Sit_Clean_SocialSit_Shoes_Stand",
    Info:
      "Kokona Haruka's best friend and closest confidant. Kokona is likely to discuss personal matters with this girl.",
  },
  {
    ID: "7",
    Name: "Kokona Haruka",
  ...
  },
  {
    ...
    Info:
      "Comes from a rich family. He tries to hide this fact from others, but his affluent origins are very obvious because of his unusual way of speaking.",
  },
  {
    ID: "14",
    Name: "Pippi Osu",
    ...
    Info:
      "Extremely unlikely to witness murder unless it takes place in the computer lab.",
  },
  {
    ID: "15",
    Name: "Ryuto Ippongo",
    ...
    ScheduleAction: "Stand_Stand_Game_Sit_Game_Sit_Clean_Game_Game",
    Info:
      "Secretly has a crush on Pippi Osu. Neither of them realize that they both share feelings for each other. \n \n Swears to his parents that he spends all of his free time studying.",
  },
  {
    ID: "16",
    Name: "Midori Gurin",
    ...
    Info:
      "Known for irritating her classmates and teachers by constantly asking foolish questions.",
  },
  {
    ID: "17",
    Name: "Sakyu Basu",
  ...
  },
  {
    ...
    ScheduleAction: "Stand_Stand_Club_Sit_Club_Sit_Clean_Club",
    Info:
      "Trusted by Oka Ruto to operate the Occult Club when she is not present.",
  },
  {
    ID: "28",
    Name: "Supana Churu",
  ...
  },
  {
    ...
    Info:
      "Last year's student council president, and this year's vice president. Currently substituting for the absent president. Known for being formal at all times.",
  },
  {
    ID: "87",
...
//   console.log(str);
//   if (str) {
//     if (str.slice(0, 3) === nextvalue.slice(0, 3)) {
//       console.log("match");
//     }
//   }
// });
